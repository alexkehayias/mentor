...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sponsor.mentorship_request'
        db.delete_column('mentorships_sponsor', 'mentorship_request_id')

        # Adding field 'Sponsor.project'
        db.add_column('mentorships_sponsor', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mentorships.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sponsor.mentorship_request'
        db.add_column('mentorships_sponsor', 'mentorship_request',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mentorships.Project']),
                      keep_default=False)

        # Deleting field 'Sponsor.project'
        db.delete_column('mentorships_sponsor', 'project_id')

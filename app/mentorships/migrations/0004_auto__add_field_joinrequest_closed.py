...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JoinRequest.closed'
        db.add_column('mentorships_joinrequest', 'closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JoinRequest.closed'
        db.delete_column('mentorships_joinrequest', 'closed')
